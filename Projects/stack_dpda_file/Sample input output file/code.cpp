...
void read_files(string dpda_file, string input_file, vector<string> &Q, vector<string> &start_end, string &A, string &Z, vector<vector<string>> &T, vector<string> &inputs)
{
    //read input
    char line[20];
...
void solution(string output_file, vector<string> &Q, vector<string> &start_end, string &A, string &Z, vector<vector<string>> &T, vector<string> &inputs)
{
...
int main(int argc, char** argv)
{
    ...
    read_files(dpda_file, input_file, Q, start_end, A, Z, T, inputs);  //read files and fills variables
    solution(output_file, Q, start_end, A, Z, T, inputs);      // process and output as a file
